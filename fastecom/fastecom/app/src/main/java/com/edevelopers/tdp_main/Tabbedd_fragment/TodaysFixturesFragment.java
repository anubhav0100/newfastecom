package com.edevelopers.tdp_main.Tabbedd_fragment;
...
import com.edevelopers.tdp_main.adapter.GridViewAdapterlayout1;
import com.edevelopers.tdp_main.adapter.GridViewAdapterlayout2;
...
public class TodaysFixturesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_todays_fixtures, container, false);
        ...
        for (int i = 0; i < fed.size(); i++) {
            ...
            try {
                if(fed.get(i).getcol4().trim().toString().equals("1")){
                    operatingSystems.add(new RecyclerViewItem(sgen.Base64ToImage(fed.get(i).getcol2().toString()), fed.get(i).getcol1(), fed.get(i).getcol4()));
                }
                else {
