...
public class GridViewAdapterlayout17 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GridViewAdapterlayout17(Activity activity, List<RecyclerViewItem> items, Animation ani) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.order_itemlist1, parent, false);
    ...
    protected class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textView,textView1,textView2,textView3,addcart,removecart;
    ...
    private void populateItemRows(ItemViewHolder viewHolder, int position) {
        ...
        viewHolder.textView1.setText("Quantity: "+mItemList.get(position).getModule1());
        viewHolder.textView3.setText(mItemList.get(position).getName().split("<#>")[2]);
    }
