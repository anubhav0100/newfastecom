...
public class Product {
    private String PC_ID, PC_NAME, DESCRIPTION, META_TAG, META_DESCRIPTION, META_KEYWORD, PC_TYPE, PC_PRIORITY,
            PRODUCT_CATEGORY_LEVEL, PC_MODEL, PC_SKU, PC_UPC, PC_EAN, PC_JAN, PC_ISBN, PC_MPN,PC_LOCATION, PC_QUANTITY,
            PC_STOCK_STATUS_ID, PC_IMG_ID, PC_MANUFACTURING_ID, PC_SHIPPING, PC_PRICE, PC_POINTS, PC_TAX_CLASS_ID, PC_DATA_AVAILABLE,
            PC_WEIGHT, PC_WEIGHT_CLASS_ID, PC_LENGTH, PC_WIDTH, PC_HEIGHT, PC_LENGTH_CLASS_ID, PC_SUBTRACT, PC_MINIMUM, PC_SORT_ORDER,
            PC_STATUS, CREATED_DATE,WISHID,CARTID;
    ...
    public Product (String PC_ID, String PC_NAME,
                    ...
                    String CREATED_DATE,String WISHID, String CARTID, boolean selected )
    {
        super();
        this.PC_ID=PC_ID;
